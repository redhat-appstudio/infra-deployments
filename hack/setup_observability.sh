...
export GRAFNA_GITHUB_CLIENT_SECRET="<base64 encoded github client secret for grafana>"
export GRAFANA_GITHUB_COOKIE_SECRET="<base64 encoded github cookie secret>"
export GRAFANA_ADMIN_USER="<admin userid for grafana>"
export GRAFANA_ADMIN_PASSWD="<password for grafana admin user>"
