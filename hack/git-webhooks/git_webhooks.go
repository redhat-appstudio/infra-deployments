...
// CreateGitWebhooks creates a new webhook (with a URL of 'webhookURL') for each repository
// with a webhook pointing directly to the smee server.
...
// DeleteGitWebhooks deletes the webhook with URL 'webhookURL' for each
// with a webhook pointing directly to the smee server. `webhookURL` should be
// the URL of the old smee server.
