...
- Production PRs must include `## Risk Assessment` (level, what could go wrong, rollback plan, blast radius) and `## Validation` (staging evidence if applicable). See `skills/risk-assessment.md` for how to write and review that section
