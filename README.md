...
3) Create a `spi-shared-configuration-file` Secret (`kubectl create secret generic `spi-shared-configuration-file` --from-file=components/spi/config.yaml -n spi-system`)
